<!--
Created: 16:08:2026 - 20:26:57
Last updated: 16:08:2026 - 20:26:57
Module: docs
File: docs/LEAF_REFERENCES.md
...
- Реестр фото-эталонов флоры (решение пользователя 16.08.2026: «листочки должны
  ...
  самое для коры»). Файлы лежат в docs/reference/<порода>/, движок их НЕ
...
<!--
UPD:
- 16:08:2026 - 20:26:57: Создан: 13 сканов Wikimedia по 6 породам + 3 листа ambientCG + 2 коры.
-->

# Фото-эталоны флоры (docs/reference/)
