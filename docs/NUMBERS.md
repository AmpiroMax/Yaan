...
Last updated: 09:08:2026 - 15:02:44
-->
<!--
UPD:
...
| `CASTLE_KEEP_HEIGHT_MIN` | 12 | м | донжон; подчинён правилу R3 (высота площадки + высший элемент — связывающее ограничение) |
| `CASTLE_KEEP_HEIGHT_MAX` | 15 | м | |
| `CASTLE_WALL_HEIGHT_MIN` | 6 | м | куртина |
| `CASTLE_WALL_HEIGHT_MAX` | 8 | м | |
| `CASTLE_TOWER_HEIGHT_MIN` | 10 | м | угловые башни (две) |
| `CASTLE_TOWER_HEIGHT_MAX` | 12 | м | |
