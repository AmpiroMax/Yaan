...
Last updated: 09:08:2026 - 15:23:14
-->
<!--
UPD:
...
| `POI_COEQUAL_VISIBLE_MAX` | 2 | шт | стенд: максимум соразмерных ориентиров в кадре (L0 не считается — C1 требует его вездесущности; составные POI считаются как один) |
