...
Last updated: 09:08:2026 - 15:08:37
-->
<!--
UPD:
...
| Константа | Значение | Единица | Примечание |
|---|---|---|---|
| `POI_VISIBLE_COUNT_MAX` | 3 | одновременно видимых | верхняя граница C2/§6.1.1; диапазонная строка выше не генерится, валидации нужен скаляр |
