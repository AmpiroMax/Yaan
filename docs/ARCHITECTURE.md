...
Last updated: 24:08:2026 - 00:48:21
-->
<!--
UPD:
...
- **Общий АДРЕСАТ РАБОТЫ:** причина была выше обеих рук — находка ушла ДВУМ
  ...
  находка идёт больше чем одному — в том же письме назван кладущий**;
  посредник, передавая чужую находку дальше, называет файл и блок и
  приписывает «сначала проверь; если уже есть — не клади, ответь ссылкой».
