...
`artifacts/acceptance/`, because the thing being fixed is something the user sees
between frames.
...
`artifacts/acceptance/sim-run-smear-{before,after}-{run,walk,stand}-116a49f.log`.
