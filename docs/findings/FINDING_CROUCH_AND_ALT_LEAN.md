...
(`docs/findings/FINDING_RUN_SMEAR.md` cost two days learning that), and on top of that
...
`artifacts/acceptance/character-alt-lean-{BEFORE,AFTER,CONTROL}-*-0825317.log`, all
