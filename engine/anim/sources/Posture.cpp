...
- 28:08:2026 - 17:40:00: Переход стал ДВИЖЕНИЕМ: posture_pose (одна функция на
  оба конца и всю середину), доли перехода, длительности. sit_pose/lie_pose
  теперь вызовы posture_pose с единичными долями.
