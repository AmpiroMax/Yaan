...
Last updated: 27:08:2026 - 01:45:00
Module: engine/app
...
constexpr std::array<Door, 77> TABLE{{
    {"DFN_TOUR",
    ...
    {"DFN_HOUSE_SEAL",
     ...
     "бит-в-бит, проёмы сквозные, переходов у дверей нет. Отрицательное плечо "
     "правила 30: «стало хуже» предъявляется одним бинарником.",
     DoorRead::Once, false},
    {"DFN_HOUSE_AO_DISK",
