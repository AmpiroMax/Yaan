...
/*
UPD:
- 17:08:2026 - 17:16:17: Создан по заказу пользователя 17.08 (лестницы + проём). Отдельный
  файл, а не строки в SceneHouseRules.cpp: тот уже упёрся в правило 21 (813
  строк), а лестница — своя тема со своим прибором (капсула), а не ещё один
  вид панели.
*/
