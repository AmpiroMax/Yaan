...
- 18:08:2026 - 18:27:14: список имён СПРАШИВАЕТСЯ У ГРАФА, а не угадывается по счётчику живых.
  Изъян нашла зона инструментов замером отмены: имена при удалении не
