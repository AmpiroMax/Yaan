...
- 27:08:2026 - 10:34:00: МЕТКА ЗАПИСИ ВЫШЕ ИСПРАВЛЕНА НА РЕАЛЬНОЕ ВРЕМЯ (правило 16):
  ...
  трогал.
- 28:08:2026 - 17:31:25: HouseSubmesh.material / span_m / wear — ИМЯ ВЕЩЕСТВА
  и его шаг повтора в файле объекта (волна 3 зоны МАТЕРИАЛЫ, формат .dfo v4, секция
  MTRL). Только добавление: пустое имя и умолчания дают ту же личность
  объекта, что до волны, — проверено на всей полке (35 файлов мебели
  перепечены с отличием ровно в ОДИН байт, и это байт версии контейнера;
  INDEX.md совпал построчно).
*/
