...
///
/// МОРФЫ ТЕЛА К ЧАСТЯМ НЕ ПРИМЕНЯЮТСЯ: цель адресует вершины потока SKIN по
/// номеру, у части свой поток. Голова едет целиком с суставом головы; глаз,
/// уехавший от морфа лица, — известный хвост волны, а не свойство формата.
struct SkinPart {
