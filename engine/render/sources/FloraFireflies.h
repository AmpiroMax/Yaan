...
- Дизайн-источники: docs/research/SKYRIM_FAUNA_RESEARCH.md §4 (Reynolds wander по
...
struct FireflyParams {
    ...
    /// Полуразмер огонька, м. Вердикт пользователя: меньше и ярче, круглый —
    /// 4 см с ярким ядром читается точкой света, а не квадратом.
    float size = 0.04f;
};
