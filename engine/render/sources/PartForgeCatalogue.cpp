...
- 17:08:2026 - 17:28:41: 24 НАСТИЛА (HOUSES.md §9): сплошные 12u/16u и с проёмом 8u/9u при
  двух сдвигах. 8u на полке НАРОЧНО — это красная рука правила, а красная
  рука обязана быть настоящей деталью, иначе правило проверено на том,
  чего в мире нет.
*/
