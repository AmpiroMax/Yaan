...
# Last updated: 22:08:2026 - 01:35:00
# Module: tools
...
zone("#c9b784", [(72,100),(120,70),(146,78),(154,104),(148,136),(132,160),(108,174),(86,162),(66,136)], h=28)
zone("#cfb47b", [(76,100),(118,76),(142,84),(148,108),(142,132),(126,152),(106,164),(90,152),(72,130)], h=29)
zone("#d4ae71", [(80,98),(116,80),(142,86),(148,110),(138,132),(118,150),(98,156),(84,142),(74,120)], h=30)
zone("#d8a768", [(84,96),(114,84),(136,90),(140,112),(130,130),(114,144),(98,148),(86,136),(78,118)], h=31)
zone("#dc9f5e", [(86,94),(112,86),(130,96),(132,114),(124,128),(110,138),(98,140),(88,130),(82,114)], h=32)
...
stone([(147,131),(143,138),(134,146),(124,150),(116,152)])
stone(MAIN)
...
oak = (52, 190)
stone([(113,214),(96,206),(78,200),(66,196),(oak[0]+3,oak[1]+1)], 6)
...
house(107.5, 148.5, 6, 7, 0, "#c8a06a", "лавка", "E", walk=(111,149), kind="shop")
house(107.5, 156, 6, 7, 0, "#c8a06a", "лавка", "E", walk=(111,155.5), kind="shop")
house(126, 149, 8, 7, 0, "#b8894f", "таверна", "W", walk=(123,150), kind="tavern")
house(125, 157.5, 7, 6, 0, "#c8a06a", None, "W", walk=(123,157))
house(124, 168.5, 7, 6, 0, "#8f8375", "кузница", "N", walk=(121,164), ns=(125*SC, 174*SC), kind="smithy")
GRAV_E = [(147,131),(143,138),(134,146),(124,150),(116,152)]
house(128, 140, 7, 6, along(GRAV_E,131,143), "#c8a06a", None, "S", walk=(130,144.5))
house(137, 149, 7, 6, along(GRAV_E,138,143), "#c8a06a", None, "N", walk=(136,145.5))
...
open("docs/WHITERUN_PLAN.json", "w", encoding="utf-8").write(json.dumps({
    ...
    "roads": ROADS_X,
    "houses": HOUSES_FULL,
    "market": {"rect": [109,146,14,11], "well": [116,151.5], "stalls": [[112,149.2],[116.5,149.2],[121,149.2]]},
