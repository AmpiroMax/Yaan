...
Last updated: 24:08:2026 - 00:37:57
Module: tools
...
//
//  ОСЬ ДВЕРИ: несогласие door_axis с ожидаемой — сигнал «ИЗМЕРЬ ТЕЛО», а не
//  «почини прибор» (замер cornhall2-forge по всем 166 строкам: расхождение
//  одно, и альтернативная эвристика на нём хуже). Измерение даёт один из
//  двух ответов, и ОБА законны: дефектный раздутый g-габарит (ряд столбов,
//  вылезший за угол, — чинится в теле) и законный (крылья ветряка, свес,
//  галерея на консолях, крыло усадьбы — так и должно быть).
//  cornhall-windmill расходится с эвристикой ВСЕГДА, по паспорту
//  (столбовка: крылья вылетают за корпус) — это норма, а не дефект.
шире, чем он есть):
