/*
Created: 28:08:2026 - 18:33:17
Last updated: 28:08:2026 - 19:07:27
Module: tools
...
/*
UPD:
- 28:08:2026 - 18:33:17: Создан — волна LOD построек (И13).
- 28:08:2026 - 19:02:29: регистрация в корневом CMakeLists.txt ОТЛОЖЕНА и названа в шапке:
  файл нёс незакоммиченную работу чужой волны, и увезти её под своим сообщением
  дороже, чем один прогон прибора руками (правило 29). Готовый кусок — выше.
- 28:08:2026 - 19:07:27: ЗАПИСЬ ВЫШЕ ОТМЕНЕНА СОБЫТИЕМ, А НЕ ОШИБКОЙ (правило 17 — не
  удаляю): чужая волна закоммитила CMakeLists.txt (7627041), файл
  освободился, и прибор зарегистрирован там, где ему место, вместе с
  обоими плечами сторожа — house_lod_full_unchanged и его контроль на
  WILL_FAIL. Кусок CMake из шапки убран: он перестал быть инструкцией и
  стал бы вторым описанием того, что теперь лежит в сборке (правило 39).
*/
