...
# Last updated: 17:08:2026 - 17:41:00
# Module: tools
...
def stairwell(scene, sx, sz, group):
    ...
    scene.place(joist, (sx + detail_start - 0.75, axis_y - joist_r, sz - 1.0),
                yaw_for(0, 1), group)
    for x in (sx + detail_start - 0.75, sx + run, far_x):
...
SIGNS_HEADER = [
    ...
    f"# - {STAMP}: На доске ДВА числа со своими именами — с какого метра проём",
