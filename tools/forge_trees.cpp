...
int main(int argc, char** argv) {
    ...
    }
    {
        ...
        //
        // ЧИСЛА СОГЛАСОВАНЫ С АРХИТЕКТОРОМ и с docs/research/TREE_PASSPORTS.md §2.5
    ...
    // догадку. docs/research/TREE_PASSPORTS.md §2.5 держит W/H в 1.1-1.3, но это полоса
