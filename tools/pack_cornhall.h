...
inline float cornhall_storey_dogleg(Forge& f, float x0, float z0, float x1, float z1,
                                    ...
                                    bool west, const char* mat, const char* tone,
                                    const char* wear) {
    const float deck_top = y + th * 0.5f;
    ...
    const float wx = west ? x0 + CORNHALL_DOGLEG_W : x1 - CORNHALL_DOGLEG_W;
    const float a0 = west ? x0 + 0.3f : x1 - 0.3f - CORNHALL_FLIGHT_W;
