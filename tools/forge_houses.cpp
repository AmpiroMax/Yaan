...
// уличный слой. Числа — docs/cities/WHITERUN_RESEARCH.md (оценки помечены там).
// ===========================================================================
...
// (docs/cities/WHITERUN_PLAN.json, периметр 316.2 м), повороты на изломах 13.9..49.2
...
/// ВОДЯНАЯ МЕЛЬНИЦА 7x7 (docs/cities/WHITERUN_PLAN.json, houses[kind=mill]: 7x7 у
...
/// КОМПАКТНЫЙ ЗАМОК ПО СХЕМЕ (docs/cities/WHITERUN_PLAN.json: houses[kind=keep] —
