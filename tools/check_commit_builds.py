...
# Last updated: 27:08:2026 - 22:41:13
...
#
# И ПРАВИЛО ДЛЯ РУКАВОВ ВООБЩЕ, выведенное из провала руки 5b (наблюдение
# bigworld-menufx): РУКА ОБЯЗАНА ПЕЧАТАТЬ ЧИСЛА, ПО КОТОРЫМ СУДИТ, а не только
# свой приговор. Ошибка в МЕХАНИЗМЕ видна по нелепому результату; ошибка в
# ПРИГОВОРЕ при верных числах нелепости не производит, и заметить её можно
# только тем, что числа стоят рядом. Здесь их печатают все руки, включая
# зелёные.
