...
# Last updated: 27:08:2026 - 10:42:28
...
# ниже кода (строки 162+ при коде с 72-й). Это не срочно и не мой файл;
# названо здесь, чтобы владелец файла решил сам, а не чтобы кто-то нашёл это
# заново. У самой проверки есть ЛОЖНОЕ СРАБАТЫВАНИЕ, о котором надо знать:
